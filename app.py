...
def solve_optimization(df,capacity):
    ...
    result_df_filter = result_df[result_df['Quantity (pcs)'] > 0]
    ...
    # Menggunakan CSS untuk memindahkan tombol ke kanan
    st.markdown("""
        <style>
    ...
    # Membuat tombol download dengan class yang sudah diatur
    with st.container():
